...
# Đã tắt lưu prompt cache
    ...
    def get_job_logs(
        ...
        """
        # Tự động quét và thu hồi các job bị treo (PROCESSING / PENDING) quá 15 phút
        try:
            ...
            if stale_jobs:
                for sj in stale_jobs:
                    ...
                    sj.error_message = "Thời gian xử lý vượt quá 15 phút (hết thời gian chờ từ NCC). Vui lòng bấm Thử lại để chạy lại."
